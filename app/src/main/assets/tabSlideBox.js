...
angular.module('tabSlideBox', [])
    ...
    .directive('tabSlideBox', [ '$timeout', '$window', '$ionicSlideBoxDelegate', '$ionicScrollDelegate','$log',
        function($timeout, $window, $ionicSlideBoxDelegate, $ionicScrollDelegate,$log) {
            'use strict';
                    ...
                    function setPosition(index){
                        ...
                        if(curEl && curEl.length){
                            ...
                            if(!scrollDiv){
                                ...
                                var currentX = (middle  - (curElLeft) -  curElWidth/2 + 5);
                                //var currentX = curElLeft;
