...
public class ToolTipView extends LinearLayout implements ViewTreeObserver.OnPreDrawListener, View.OnClickListener {
    ...
    private void init() {
        ...
        LayoutInflater.from(getContext()).inflate(in.helpchat.webviewtesting.R.layout.tooltip, this, true);

        mTopPointerView = (ImageView) findViewById(in.helpchat.webviewtesting.R.id.tooltip_pointer_up);
        mTopFrame = findViewById(in.helpchat.webviewtesting.R.id.tooltip_topframe);
        mContentHolder = (ViewGroup) findViewById(in.helpchat.webviewtesting.R.id.tooltip_contentholder);
        mToolTipTV = (TextView) findViewById(in.helpchat.webviewtesting.R.id.tooltip_contenttv);
        mBottomFrame = findViewById(in.helpchat.webviewtesting.R.id.tooltip_bottomframe);
        mBottomPointerView = (ImageView) findViewById(in.helpchat.webviewtesting.R.id.tooltip_pointer_down);
        mShadowView = findViewById(in.helpchat.webviewtesting.R.id.tooltip_shadow);
